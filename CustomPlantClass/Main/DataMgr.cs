...
namespace CustomPlantClass.Main
{
    ...
    public class DataMgr : MonoBehaviour
    {
        ...
        {
            if (!CustomCore.CustomUltimatePlants.Contains(thePlantType)) CustomCore.AddUltimatePlant(thePlantType);
            ...
            if (isVariant && theVariantType != PlantType.Nothing && !CustomCore.CustomBanMix.ContainsKey(theVariantType))
            {
                ...
                if (!CustomCore.CustomUltimatePlants.Contains(theVariantType)) CustomCore.AddUltimatePlant(theVariantType);
